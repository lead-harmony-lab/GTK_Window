...
class MyGLArea(Gtk.GLArea):
    ...
    def on_realize(self, area):
        ...
        # Creates a new data store for the buffer object currently bound to target. Static_Draw indicates the data store contents will be modified once and used many times.
    ...
    def on_render(self, area, ctx):
        ...
        model_matrix = Matrix44.from_translation([0.0, 0.0, 0.0]) * pyrr.matrix44.create_from_axis_rotation(
            (0.0, 1.0, 0.0), 4 * ct) * Matrix44.from_scale([1.0, 1.0, 1.0])
